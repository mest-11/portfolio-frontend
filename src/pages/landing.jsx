  ...
  return (
    <div className="bg-slate-200 flex justify-center items-center px-[20rem] py-[10rem] overscroll-none">
      ...
      <div className="flex flex-col gap-y-10 pt-10">
        <button className='p-10 w-[20rem] h-[5rem] bg-portBlue rounded-[30px] text-black text-[20px] font-semibold antialiased flex flex-col justify-center items-center shadow-lg shadow-slate-200'><a href="/login">Already have an account</a></button>
